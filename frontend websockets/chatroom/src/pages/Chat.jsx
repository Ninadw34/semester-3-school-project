...
const Chat = () =>{
  ...
  const [kleur, setChatKleur] = useState("");
  ...
  const KleurChange = () => {
    const bericht = document.getElementById("chatbox");
    const color = document.getElementById("selectColor").innerText;

    switch(color){
      case "Zwart":
        bericht.innerText.style.color = "black";
        break;
      case "Rood":
        bericht.innerText.style.color = "red";
        break;
    }
  }
	const ShowChat = () => {
